...
Route::get('/merchandiser', [MerchandiserController::class, 'index'])->middleware(['auth', 'verified'])->name('merchandiser');
...
Route::get('/shipping', [App\Http\Controllers\ShippingController::class, 'index'])->middleware(['auth', 'verified'])->name('shipping');
