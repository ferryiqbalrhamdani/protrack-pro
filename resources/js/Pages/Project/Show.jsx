                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-slate-500 mt-1">Detail Proyek &amp; Keterhubungan Modul</p>
                                    </div>
                                </div>
                    ...
                    <div className="xl:hidden animate-reveal space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Detail Proyek Management</p>
                            </div>
                        </div>
